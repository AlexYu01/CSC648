<header>
    ...
    <nav id="team5-menu" class="team5-menu" lang="en" style="position:fixed;right:0;left:0;z-index:1;">
        ...
        <div id="wm-user-component">
            ...
            if ($this->request->session()->read('Auth')) {
                ...
                echo '<a class="signin" style="border:0px;" href='. $this->Url->build(['controller'=>'Media','action'=>'posts']) .'><span class="fa-layers fa-fw" style="font-size: 2em;">
    ...
    <script>
        var login =  '<?php
                    ...
                    ?>'
        var counter = <?php if(!empty($counter)){ echo $counters;}else{echo '0';}?>
