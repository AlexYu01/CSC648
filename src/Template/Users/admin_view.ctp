...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    ...
    <ul class="side-nav">
        ...
        <li><?=
            $this->Form->postLink( __( 'Delete User' ), ['action' => 'delete',
                $user->user_id], ['confirm' => __( 'Are you sure you want to delete # {0}?', $user->user_id )] )
            ?> </li>
        <li><?=
            $this->Html->link( __( 'List Users' ), ['controller' => 'Users',
                'action' => 'index'] )
            ?> </li>
...
<div class="users view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        <tr>
            ...
            <td><?=
                $user->has( 'user' ) ? $this->Html->link( $user->user_id, [
